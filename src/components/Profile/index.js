          ...
          <div className="post-item">
                ...
                <div className="post-item-content">
                  <p className="post-item-text">
                    ...
                    blanditiis consequatur, deserunt facere iusto amet a ad
                    suscipit laudantium unde quidem perferendis!
                  </p>
                  <p className="post-item-text">
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Et
                    inventore obcaecati eum deserunt ut, aperiam quas! Placeat
                ...
                <div className="post-item-footer">
                  <a href="#" className="post-item-show">
                    <img src="./assets/images/heart-icon-no-filled.svg" className="post-item-icon heart-icon" alt="heart-icon" />
                    <span className="comment-count">123</span>
                  </a>
                  <a href="#" className="post-item-show">
                    <img src="./assets/images/comment-icon-footer.svg" className="post-item-icon comment-icon" alt="heart-icon" />
                    <span className="comment-count">123</span>
                  </a>
                </div>
              </div>
